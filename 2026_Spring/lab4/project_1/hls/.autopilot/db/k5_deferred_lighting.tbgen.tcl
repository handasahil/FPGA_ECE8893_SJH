...
set C_modelArgList {
	...
	{ framebuffer int 64 regular {fifo 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out_pixels","offset": { "type": "dynamic","port_name": "out_pixels","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "framebuffer", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set Spec2ImplPortList { 
	...
	framebuffer { ap_fifo {  { framebuffer_dout fifo_data_in 0 64 }  { framebuffer_empty_n fifo_status 0 1 }  { framebuffer_read fifo_port_we 1 1 }  { framebuffer_num_data_valid fifo_status_num_data_valid 0 4 }  { framebuffer_fifo_cap fifo_update 0 4 } } }
