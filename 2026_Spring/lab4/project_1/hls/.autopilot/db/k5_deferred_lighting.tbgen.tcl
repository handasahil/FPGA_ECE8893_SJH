set moduleName k5_deferred_lighting
set isTopModule 0
...
dict set ap_memory_interface_dict depth_buffer { MEM_WIDTH 32 MEM_SIZE 16384 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict normal_buffer_x { MEM_WIDTH 32 MEM_SIZE 16384 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict normal_buffer_y { MEM_WIDTH 32 MEM_SIZE 16384 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict normal_buffer_z { MEM_WIDTH 32 MEM_SIZE 16384 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ gmem1 int 32 regular {axi_master 1}  }
	{ framebuffer int 64 regular  }
	{ depth_buffer int 32 regular {array 4096 { 1 3 } 1 1 } {global 0}  }
	{ normal_buffer_x int 32 regular {array 4096 { 1 3 } 1 1 } {global 0}  }
	{ normal_buffer_y int 32 regular {array 4096 { 1 3 } 1 1 } {global 0}  }
	{ normal_buffer_z int 32 regular {array 4096 { 1 3 } 1 1 } {global 0}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out_pixels","offset": { "type": "dynamic","port_name": "out_pixels","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "framebuffer", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "depth_buffer", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "normal_buffer_x", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "normal_buffer_y", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "normal_buffer_z", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ framebuffer sc_in sc_lv 64 signal 1 } 
	...
	{ normal_buffer_x_address0 sc_out sc_lv 12 signal 3 } 
	{ normal_buffer_x_ce0 sc_out sc_logic 1 signal 3 } 
	{ normal_buffer_x_q0 sc_in sc_lv 32 signal 3 } 
	{ normal_buffer_y_address0 sc_out sc_lv 12 signal 4 } 
	{ normal_buffer_y_ce0 sc_out sc_logic 1 signal 4 } 
	{ normal_buffer_y_q0 sc_in sc_lv 32 signal 4 } 
	{ normal_buffer_z_address0 sc_out sc_lv 12 signal 5 } 
	{ normal_buffer_z_ce0 sc_out sc_logic 1 signal 5 } 
	{ normal_buffer_z_q0 sc_in sc_lv 32 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "framebuffer", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "framebuffer", "role": "default" }} , 
 	...
 	{ "name": "normal_buffer_x_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "normal_buffer_x", "role": "q0" }} , 
 	...
 	{ "name": "normal_buffer_y_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "normal_buffer_y", "role": "q0" }} , 
 	...
 	{ "name": "normal_buffer_z_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "normal_buffer_z", "role": "q0" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "24710", "Max" : "24710"}
	, {"Name" : "Interval", "Min" : "24710", "Max" : "24710"}
]}
...
set Spec2ImplPortList { 
	...
	framebuffer { ap_none {  { framebuffer in_data 0 64 } } }
	depth_buffer { ap_memory {  { depth_buffer_address0 mem_address 1 12 }  { depth_buffer_ce0 mem_ce 1 1 }  { depth_buffer_q0 mem_dout 0 32 } } }
	normal_buffer_x { ap_memory {  { normal_buffer_x_address0 mem_address 1 12 }  { normal_buffer_x_ce0 mem_ce 1 1 }  { normal_buffer_x_q0 mem_dout 0 32 } } }
	normal_buffer_y { ap_memory {  { normal_buffer_y_address0 mem_address 1 12 }  { normal_buffer_y_ce0 mem_ce 1 1 }  { normal_buffer_y_q0 mem_dout 0 32 } } }
	normal_buffer_z { ap_memory {  { normal_buffer_z_address0 mem_address 1 12 }  { normal_buffer_z_ce0 mem_ce 1 1 }  { normal_buffer_z_q0 mem_dout 0 32 } } }
}
