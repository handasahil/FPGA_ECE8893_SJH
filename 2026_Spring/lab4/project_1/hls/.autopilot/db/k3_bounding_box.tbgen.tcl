...
set C_modelArgList {
	...
	{ bounds_min_x int 15 regular {array 128 { 0 3 } 0 1 } {global 1}  }
	{ bounds_max_x int 16 regular {array 128 { 0 3 } 0 1 } {global 1}  }
	{ bounds_min_y int 15 regular {array 128 { 0 3 } 0 1 } {global 1}  }
	{ bounds_max_y int 16 regular {array 128 { 0 3 } 0 1 } {global 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "screen_tris_is_active", "interface" : "memory", "bitwidth" : 1, "direction" : "READONLY", "extern" : 0} , 
 	...
 	{ "Name" : "bounds_min_x", "interface" : "memory", "bitwidth" : 15, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "bounds_max_x", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "bounds_min_y", "interface" : "memory", "bitwidth" : 15, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "bounds_max_y", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ screen_tris_is_active_address0 sc_out sc_lv 7 signal 0 } 
	{ screen_tris_is_active_ce0 sc_out sc_logic 1 signal 0 } 
	{ screen_tris_is_active_q0 sc_in sc_lv 1 signal 0 } 
	{ screen_tris_v0_x_address0 sc_out sc_lv 7 signal 1 } 
	{ screen_tris_v0_x_ce0 sc_out sc_logic 1 signal 1 } 
	{ screen_tris_v0_x_q0 sc_in sc_lv 32 signal 1 } 
	{ screen_tris_v1_x_address0 sc_out sc_lv 7 signal 2 } 
	{ screen_tris_v1_x_ce0 sc_out sc_logic 1 signal 2 } 
	{ screen_tris_v1_x_q0 sc_in sc_lv 32 signal 2 } 
	{ screen_tris_v2_x_address0 sc_out sc_lv 7 signal 3 } 
	{ screen_tris_v2_x_ce0 sc_out sc_logic 1 signal 3 } 
	{ screen_tris_v2_x_q0 sc_in sc_lv 32 signal 3 } 
	{ screen_tris_v0_y_address0 sc_out sc_lv 7 signal 4 } 
	{ screen_tris_v0_y_ce0 sc_out sc_logic 1 signal 4 } 
	{ screen_tris_v0_y_q0 sc_in sc_lv 32 signal 4 } 
	{ screen_tris_v1_y_address0 sc_out sc_lv 7 signal 5 } 
	{ screen_tris_v1_y_ce0 sc_out sc_logic 1 signal 5 } 
	{ screen_tris_v1_y_q0 sc_in sc_lv 32 signal 5 } 
	{ screen_tris_v2_y_address0 sc_out sc_lv 7 signal 6 } 
	{ screen_tris_v2_y_ce0 sc_out sc_logic 1 signal 6 } 
	{ screen_tris_v2_y_q0 sc_in sc_lv 32 signal 6 } 
	{ bounds_min_x_address0 sc_out sc_lv 7 signal 7 } 
	{ bounds_min_x_ce0 sc_out sc_logic 1 signal 7 } 
	{ bounds_min_x_we0 sc_out sc_logic 1 signal 7 } 
	{ bounds_min_x_d0 sc_out sc_lv 15 signal 7 } 
	{ bounds_max_x_address0 sc_out sc_lv 7 signal 8 } 
	{ bounds_max_x_ce0 sc_out sc_logic 1 signal 8 } 
	{ bounds_max_x_we0 sc_out sc_logic 1 signal 8 } 
	{ bounds_max_x_d0 sc_out sc_lv 16 signal 8 } 
	{ bounds_min_y_address0 sc_out sc_lv 7 signal 9 } 
	{ bounds_min_y_ce0 sc_out sc_logic 1 signal 9 } 
	{ bounds_min_y_we0 sc_out sc_logic 1 signal 9 } 
	{ bounds_min_y_d0 sc_out sc_lv 15 signal 9 } 
	{ bounds_max_y_address0 sc_out sc_lv 7 signal 10 } 
	{ bounds_max_y_ce0 sc_out sc_logic 1 signal 10 } 
	{ bounds_max_y_we0 sc_out sc_logic 1 signal 10 } 
	{ bounds_max_y_d0 sc_out sc_lv 16 signal 10 } 
}
set NewPortList {[ 
...
set ArgLastReadFirstWriteLatency {
	k3_bounding_box {
		screen_tris_is_active {Type I LastRead 1 FirstWrite -1}
		screen_tris_v0_x {Type I LastRead 2 FirstWrite -1}
		screen_tris_v1_x {Type I LastRead 2 FirstWrite -1}
		screen_tris_v2_x {Type I LastRead 2 FirstWrite -1}
		screen_tris_v0_y {Type I LastRead 2 FirstWrite -1}
		screen_tris_v1_y {Type I LastRead 2 FirstWrite -1}
		screen_tris_v2_y {Type I LastRead 2 FirstWrite -1}
		bounds_min_x {Type O LastRead -1 FirstWrite 2}
		bounds_max_x {Type O LastRead -1 FirstWrite 2}
		bounds_min_y {Type O LastRead -1 FirstWrite 2}
		bounds_max_y {Type O LastRead -1 FirstWrite 2}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "385", "Max" : "513"}
	, {"Name" : "Interval", "Min" : "385", "Max" : "513"}
]}
...
set Spec2ImplPortList { 
	...
	bounds_min_x { ap_memory {  { bounds_min_x_address0 mem_address 1 7 }  { bounds_min_x_ce0 mem_ce 1 1 }  { bounds_min_x_we0 mem_we 1 1 }  { bounds_min_x_d0 mem_din 1 15 } } }
	bounds_max_x { ap_memory {  { bounds_max_x_address0 mem_address 1 7 }  { bounds_max_x_ce0 mem_ce 1 1 }  { bounds_max_x_we0 mem_we 1 1 }  { bounds_max_x_d0 mem_din 1 16 } } }
	bounds_min_y { ap_memory {  { bounds_min_y_address0 mem_address 1 7 }  { bounds_min_y_ce0 mem_ce 1 1 }  { bounds_min_y_we0 mem_we 1 1 }  { bounds_min_y_d0 mem_din 1 15 } } }
	bounds_max_y { ap_memory {  { bounds_max_y_address0 mem_address 1 7 }  { bounds_max_y_ce0 mem_ce 1 1 }  { bounds_max_y_we0 mem_we 1 1 }  { bounds_max_y_d0 mem_din 1 16 } } }
}
