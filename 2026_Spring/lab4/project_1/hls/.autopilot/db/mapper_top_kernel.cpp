...
std::vector<Byte<128>> __xlx_in_tris__tmp_vec;
for (size_t i = 0; i < 92; ++i){
__xlx_in_tris__tmp_vec.push_back(((Byte<128>*)__xlx_apatb_param_in_tris)[i]);
}
...
__xlx_mvp_matrix__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_mvp_matrix)[i]);
}
