...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename mvp_matrix \
    op interface \
    ports { mvp_matrix_address0 { O 4 vector } mvp_matrix_ce0 { O 1 bit } mvp_matrix_q0 { I 32 vector } mvp_matrix_address1 { O 4 vector } mvp_matrix_ce1 { O 1 bit } mvp_matrix_q1 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'mvp_matrix'"
}
}
