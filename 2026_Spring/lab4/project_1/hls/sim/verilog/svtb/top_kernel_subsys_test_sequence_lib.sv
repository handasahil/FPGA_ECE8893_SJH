                        ...
                        begin
                            ...
                            for(int i=0; i<1; i++) begin
                                ...
                                for(int j=0; j < (64+32-1)/32; j++) begin
                                    data64bit_in_tris.push_back( ((refm.mem_blk_pages_gmem0.maxi_bundlevar_offset["in_tris"]+refm.mem_blk_pages_gmem0.page_ofst[refm.mem_blk_pages_gmem0.rd_page_idx])>>(j*32)) & (2**32-1) );
                                end
                                ...
                                axi_master_wr_control_seq.StableAxiliteNoUpdate=0;
                                for(int j=0; j < (64+32-1)/32; j++) begin
                                    data64bit_out_pixels.push_back( ((refm.mem_blk_pages_gmem1.maxi_bundlevar_offset["out_pixels"]+refm.mem_blk_pages_gmem1.page_ofst[refm.mem_blk_pages_gmem1.rd_page_idx])>>(j*32)) & (2**32-1) );
                                end
