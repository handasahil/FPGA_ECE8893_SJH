set moduleName compute_Pipeline_VITIS_LOOP_34_1_VITIS_LOOP_35_2
set isTopModule 0
...
set cdfgNum 12
set C_modelName {compute_Pipeline_VITIS_LOOP_34_1_VITIS_LOOP_35_2}
...
set C_modelArgList {
	{ bufferA int 24 regular {array 16384 { 0 3 } 0 1 }  }
	{ bufferA_1 int 24 regular {array 16384 { 0 3 } 0 1 }  }
	{ bufferA_2 int 24 regular {array 16384 { 0 3 } 0 1 }  }
	{ bufferA_3 int 24 regular {array 16384 { 0 3 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "bufferA", "interface" : "memory", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
 	{ "Name" : "bufferA_1", "interface" : "memory", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
 	{ "Name" : "bufferA_2", "interface" : "memory", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
 	{ "Name" : "bufferA_3", "interface" : "memory", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ grid_initial_dout sc_in sc_lv 24 signal 4 } 
	{ grid_initial_empty_n sc_in sc_logic 1 signal 4 } 
	{ grid_initial_read sc_out sc_logic 1 signal 4 } 
	{ grid_initial_num_data_valid sc_in sc_lv 3 signal 4 } 
	{ grid_initial_fifo_cap sc_in sc_lv 3 signal 4 } 
...
set Spec2ImplPortList { 
	bufferA { ap_memory {  { bufferA_address0 mem_address 1 14 }  { bufferA_ce0 mem_ce 1 1 }  { bufferA_we0 mem_we 1 1 }  { bufferA_d0 mem_din 1 24 } } }
	bufferA_1 { ap_memory {  { bufferA_1_address0 mem_address 1 14 }  { bufferA_1_ce0 mem_ce 1 1 }  { bufferA_1_we0 mem_we 1 1 }  { bufferA_1_d0 mem_din 1 24 } } }
	bufferA_2 { ap_memory {  { bufferA_2_address0 mem_address 1 14 }  { bufferA_2_ce0 mem_ce 1 1 }  { bufferA_2_we0 mem_we 1 1 }  { bufferA_2_d0 mem_din 1 24 } } }
	bufferA_3 { ap_memory {  { bufferA_3_address0 mem_address 1 14 }  { bufferA_3_ce0 mem_ce 1 1 }  { bufferA_3_we0 mem_we 1 1 }  { bufferA_3_d0 mem_din 1 24 } } }
