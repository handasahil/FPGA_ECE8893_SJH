set moduleName top_kernel_Pipeline_VITIS_LOOP_35_4
set isTopModule 0
...
set cdfgNum 4
set C_modelName {top_kernel_Pipeline_VITIS_LOOP_35_4}
...
set C_modelArgList {
	{ cur int 24 regular {array 65536 { 1 1 } 1 1 } {global 0}  }
	{ nxt int 24 regular {array 65536 { 0 0 } 0 1 } {global 1}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "cur", "interface" : "memory", "bitwidth" : 24, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "nxt", "interface" : "memory", "bitwidth" : 24, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ cur_address1 sc_out sc_lv 16 signal 0 } 
	{ cur_ce1 sc_out sc_logic 1 signal 0 } 
	{ cur_q1 sc_in sc_lv 24 signal 0 } 
	{ nxt_address0 sc_out sc_lv 16 signal 1 } 
	{ nxt_ce0 sc_out sc_logic 1 signal 1 } 
	{ nxt_we0 sc_out sc_logic 1 signal 1 } 
	{ nxt_d0 sc_out sc_lv 24 signal 1 } 
	{ nxt_address1 sc_out sc_lv 16 signal 1 } 
	{ nxt_ce1 sc_out sc_logic 1 signal 1 } 
	{ nxt_we1 sc_out sc_logic 1 signal 1 } 
	{ nxt_d1 sc_out sc_lv 24 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "cur_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "cur", "role": "address1" }} , 
...
set Spec2ImplPortList { 
	cur { ap_memory {  { cur_address0 mem_address 1 16 }  { cur_ce0 mem_ce 1 1 }  { cur_q0 mem_dout 0 24 }  { cur_address1 MemPortADDR2 1 16 }  { cur_ce1 MemPortCE2 1 1 }  { cur_q1 MemPortDOUT2 0 24 } } }
