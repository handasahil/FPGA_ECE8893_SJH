set moduleName compute_Pipeline_VITIS_LOOP_33_1_VITIS_LOOP_34_2
set isTopModule 0
...
set cdfgNum 12
set C_modelName {compute_Pipeline_VITIS_LOOP_33_1_VITIS_LOOP_34_2}
...
set C_modelArgList {
	{ buffer_r int 24 regular {array 32768 { 0 3 } 0 1 }  }
	{ buffer_1 int 24 regular {array 32768 { 0 3 } 0 1 }  }
	{ buffer_2 int 24 regular {array 32768 { 0 3 } 0 1 }  }
	{ buffer_3 int 24 regular {array 32768 { 0 3 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "buffer_r", "interface" : "memory", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
 	{ "Name" : "buffer_1", "interface" : "memory", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
 	{ "Name" : "buffer_2", "interface" : "memory", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
 	{ "Name" : "buffer_3", "interface" : "memory", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
...
set Spec2ImplPortList { 
	buffer_r { ap_memory {  { buffer_r_address0 mem_address 1 15 }  { buffer_r_ce0 mem_ce 1 1 }  { buffer_r_we0 mem_we 1 1 }  { buffer_r_d0 mem_din 1 24 } } }
	buffer_1 { ap_memory {  { buffer_1_address0 mem_address 1 15 }  { buffer_1_ce0 mem_ce 1 1 }  { buffer_1_we0 mem_we 1 1 }  { buffer_1_d0 mem_din 1 24 } } }
	buffer_2 { ap_memory {  { buffer_2_address0 mem_address 1 15 }  { buffer_2_ce0 mem_ce 1 1 }  { buffer_2_we0 mem_we 1 1 }  { buffer_2_d0 mem_din 1 24 } } }
	buffer_3 { ap_memory {  { buffer_3_address0 mem_address 1 15 }  { buffer_3_ce0 mem_ce 1 1 }  { buffer_3_we0 mem_we 1 1 }  { buffer_3_d0 mem_din 1 24 } } }
