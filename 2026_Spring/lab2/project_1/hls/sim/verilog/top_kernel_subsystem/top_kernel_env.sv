...
`ifndef TOP_KERNEL_ENV__SV                                                                                   
    ...
    class top_kernel_env extends uvm_env;                                                                          
        ...
        axi_pkg::axi_env#(64,4,8,3,1) axi_master_A_in;
        axi_pkg::axi_env#(64,4,8,3,1) axi_master_A_out;
    ...
    function void top_kernel_env::build_phase(uvm_phase phase);                                                    
        ...
        top_kernel_cfg.A_in_cfg.set_default();
        top_kernel_cfg.A_in_cfg.drv_type = axi_pkg::SLAVE;
        top_kernel_cfg.A_in_cfg.reset_level = axi_pkg::RESET_LEVEL_LOW;
        top_kernel_cfg.A_in_cfg.write_latency_mode = TRANSACTION_FIRST;
        top_kernel_cfg.A_in_cfg.read_latency_mode = TRANSACTION_FIRST;
        uvm_config_db#(axi_pkg::axi_cfg)::set(this, "axi_master_A_in*", "cfg", top_kernel_cfg.A_in_cfg);
        axi_master_A_in = axi_pkg::axi_env#(64,4,8,3,1)::type_id::create("axi_master_A_in", this);

        top_kernel_cfg.A_out_cfg.set_default();
        top_kernel_cfg.A_out_cfg.drv_type = axi_pkg::SLAVE;
        top_kernel_cfg.A_out_cfg.reset_level = axi_pkg::RESET_LEVEL_LOW;
        top_kernel_cfg.A_out_cfg.write_latency_mode = TRANSACTION_FIRST;
        top_kernel_cfg.A_out_cfg.read_latency_mode = TRANSACTION_FIRST;
        uvm_config_db#(axi_pkg::axi_cfg)::set(this, "axi_master_A_out*", "cfg", top_kernel_cfg.A_out_cfg);
        axi_master_A_out = axi_pkg::axi_env#(64,4,8,3,1)::type_id::create("axi_master_A_out", this);
    ...
    function void top_kernel_env::connect_phase(uvm_phase phase);
        ...
        if(top_kernel_cfg.A_in_cfg.drv_type==axi_pkg::MASTER ||top_kernel_cfg.A_in_cfg.drv_type==axi_pkg::SLAVE)
            top_kernel_virtual_sqr.A_in_sqr = axi_master_A_in.vsqr;
        axi_master_A_in.item_wtr_port.connect(subsys_mon.A_in_wtr_imp);
        axi_master_A_in.item_rtr_port.connect(subsys_mon.A_in_rtr_imp);
        uvm_callbacks#(axi_pkg::axi_state, axi_pkg::axi_state_cbs)::add(axi_master_A_in.state, refm.axi_memaccess_cb_A_in);
        if(top_kernel_cfg.A_out_cfg.drv_type==axi_pkg::MASTER ||top_kernel_cfg.A_out_cfg.drv_type==axi_pkg::SLAVE)
            top_kernel_virtual_sqr.A_out_sqr = axi_master_A_out.vsqr;
        axi_master_A_out.item_wtr_port.connect(subsys_mon.A_out_wtr_imp);
        axi_master_A_out.item_rtr_port.connect(subsys_mon.A_out_rtr_imp);
        uvm_callbacks#(axi_pkg::axi_state, axi_pkg::axi_state_cbs)::add(axi_master_A_out.state, refm.axi_memaccess_cb_A_out);
