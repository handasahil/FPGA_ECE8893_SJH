...
class memaccess_axi_state_cbs extends axi_pkg::axi_state_cbs;
    ...
    virtual function void memmodel_read_fromar(ref logic[7:0] data[$], input longint addr, input longint len);
        if(memid=="A_in") refm.mem_blk_pages_A_in.read_elems_pipepage(data, addr, len);
        if(memid=="A_out") refm.mem_blk_pages_A_out.read_elems_pipepage(data, addr, len);
    endfunction
endclass

class top_kernel_reference_model extends uvm_component;
`define TV_IN_A_in "../tv/cdatafile/c.top_kernel.autotvin_A_in.dat"
`define TV_OUT_A_in "../tv/rtldatafile/rtl.top_kernel.autotvout_A_in.dat"
`define TV_IN_OFFSET_A_in_r "../tv/cdatafile/c.top_kernel.autotvin_A_in_r.dat"
`define TV_IN_A_out "../tv/cdatafile/c.top_kernel.autotvin_A_out.dat"
`define TV_OUT_A_out "../tv/rtldatafile/rtl.top_kernel.autotvout_A_out.dat"
`define TV_IN_OFFSET_A_out_r "../tv/cdatafile/c.top_kernel.autotvin_A_out_r.dat"
`define TV_IN_A_in_r "../tv/cdatafile/c.top_kernel.autotvin_A_in_r.dat"
`define TV_OUT_A_in_r ""
`define TV_IN_A_out_r "../tv/cdatafile/c.top_kernel.autotvin_A_out_r.dat"
`define TV_OUT_A_out_r ""
    ...
    mem_model_pages_with_diffofst#(32,8) mem_blk_pages_A_in;
    int blk_id_A_in = 0;
    memaccess_axi_state_cbs axi_memaccess_cb_A_in;

    mem_model_pages_with_diffofst#(32,8) mem_blk_pages_A_out;
    int blk_id_A_out = 0;
    memaccess_axi_state_cbs axi_memaccess_cb_A_out;
    ...
    virtual function void build_phase(uvm_phase phase);
        ...
        axi_memaccess_cb_A_in = new;
        axi_memaccess_cb_A_in.refm = this;
        axi_memaccess_cb_A_in.memid = "A_in";
        axi_memaccess_cb_A_out = new;
        axi_memaccess_cb_A_out.refm = this;
        axi_memaccess_cb_A_out.memid = "A_out";
    endfunction
...
misc_if.dut2tb_ap_done = 0;
        ...
        mem_blk_pages_A_in = mem_model_pages_with_diffofst#(32,8)::type_id::create("mem_blk_pages_A_in");
        mem_blk_pages_A_in.whole_page_size=262208;
        mem_blk_pages_A_in.maxi_bundlevar_fpath["A_in_r"]=`TV_IN_OFFSET_A_in_r;
        mem_blk_pages_A_in.set_binary(1);
        mem_blk_pages_A_in.tvinload_pagechk_atinit(fpath, 65536*((32+7)/8), 0, 0, "");
        fpath.delete();

        fpath.push_back(`TV_IN_A_out);
        mem_blk_pages_A_out = mem_model_pages_with_diffofst#(32,8)::type_id::create("mem_blk_pages_A_out");
        mem_blk_pages_A_out.whole_page_size=262208;
        mem_blk_pages_A_out.maxi_bundlevar_fpath["A_out_r"]=`TV_IN_OFFSET_A_out_r;
        mem_blk_pages_A_out.set_binary(1);
        mem_blk_pages_A_out.tvinload_pagechk_atinit(fpath, 65536*((32+7)/8), 0, 0, "");
        mem_blk_pages_A_out.tvoutdump_atinit(`TV_OUT_A_out);
        fpath.delete();
        ...
        fork
            ...
            for(int i=1; i<1; i++) begin
                @dut2tb_ap_ready;
                mem_blk_pages_A_in.incr_rd_page_idx() ;
                mem_blk_pages_A_out.incr_rd_page_idx() ;
            end
            forever begin
                forever begin
                    @(negedge misc_if.clock);
    ...
    virtual function void write_axi_wtr_A_in(axi_pkg::axi_transfer tr);
        mem_blk_pages_A_in.write_elems_pipepage(tr.data,tr.byte_addr);
    endfunction

    virtual function void write_axi_rtr_A_in(axi_pkg::axi_transfer tr);
    endfunction

    virtual function void write_axi_wtr_A_out(axi_pkg::axi_transfer tr);
        mem_blk_pages_A_out.write_elems_pipepage(tr.data,tr.byte_addr);
    endfunction

    virtual function void write_axi_rtr_A_out(axi_pkg::axi_transfer tr);
    endfunction
