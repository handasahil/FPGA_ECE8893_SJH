    ...
    function [288:0] proc_path(input [PROC_NUM - 1:0] dl_vec);
        ...
        begin
            ...
            case (index)
                ...
                2 : begin
                    proc_path = "top_kernel.compute_U0";
                end
                3 : begin
...
// for dep channel 'top_kernel.A_out_r_c_U' info is :
// blk sig is {~AESL_inst_top_kernel.entry_proc_U0.A_out_r_c_blk_n data_FIFO}
                        if ((~AESL_inst_top_kernel.entry_proc_U0.A_out_r_c_blk_n)) begin
                            if (~AESL_inst_top_kernel.A_out_r_c_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'top_kernel.A_out_r_c_U' written by process 'top_kernel.write_output_U0'");
                                $fdisplay(fp, "Dependence_Channel_path top_kernel.A_out_r_c_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~AESL_inst_top_kernel.A_out_r_c_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'top_kernel.A_out_r_c_U' read by process 'top_kernel.write_output_U0'");
                                $fdisplay(fp, "Dependence_Channel_path top_kernel.A_out_r_c_U");
...
// blk sig is {{AESL_inst_top_kernel.ap_sync_read_input_U0_ap_ready & AESL_inst_top_kernel.read_input_U0.ap_idle & ~AESL_inst_top_kernel.ap_sync_entry_proc_U0_ap_ready} input_sync}
                ...
                2 : begin // for proc 'top_kernel.compute_U0'
                    case(index2)
                    1: begin //  for dep proc 'top_kernel.read_input_U0'
// for dep channel 'top_kernel.grid_initial_U' info is :
// blk sig is {~AESL_inst_top_kernel.compute_U0.grp_compute_Pipeline_VITIS_LOOP_34_1_VITIS_LOOP_35_2_fu_104.grid_initial_blk_n data_FIFO}
                        if ((~AESL_inst_top_kernel.compute_U0.grp_compute_Pipeline_VITIS_LOOP_34_1_VITIS_LOOP_35_2_fu_104.grid_initial_blk_n)) begin
                            if (~AESL_inst_top_kernel.grid_initial_U.if_empty_n) begin
...
// blk sig is {~AESL_inst_top_kernel.compute_U0.grp_compute_Pipeline_VITIS_LOOP_133_9_VITIS_LOOP_134_10_fu_131.grid_final_blk_n data_FIFO}
                        if ((~AESL_inst_top_kernel.compute_U0.grp_compute_Pipeline_VITIS_LOOP_133_9_VITIS_LOOP_134_10_fu_131.grid_final_blk_n)) begin
                ...
                3 : begin // for proc 'top_kernel.write_output_U0'
                    case(index2)
                    2: begin //  for dep proc 'top_kernel.compute_U0'
// for dep channel 'top_kernel.grid_final_U' info is :
// blk sig is {~AESL_inst_top_kernel.write_output_U0.grid_final_blk_n data_FIFO}
                    ...
                    0: begin //  for dep proc 'top_kernel.entry_proc_U0'
// for dep channel 'top_kernel.A_out_r_c_U' info is :
// blk sig is {~AESL_inst_top_kernel.write_output_U0.A_out1_blk_n data_FIFO}
                        if ((~AESL_inst_top_kernel.write_output_U0.A_out1_blk_n)) begin
                            if (~AESL_inst_top_kernel.A_out_r_c_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'top_kernel.A_out_r_c_U' written by process 'top_kernel.entry_proc_U0'");
                                $fdisplay(fp, "Dependence_Channel_path top_kernel.A_out_r_c_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~AESL_inst_top_kernel.A_out_r_c_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'top_kernel.A_out_r_c_U' read by process 'top_kernel.entry_proc_U0'");
                                $fdisplay(fp, "Dependence_Channel_path top_kernel.A_out_r_c_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
