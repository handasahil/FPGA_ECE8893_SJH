...
#define AUTOTB_TVOUT_A_in_r "../tv/cdatafile/c.top_kernel.autotvout_A_in_r.dat"
#define AUTOTB_TVIN_A_out_r "../tv/cdatafile/c.top_kernel.autotvin_A_out_r.dat"
#define AUTOTB_TVOUT_A_out_r "../tv/cdatafile/c.top_kernel.autotvout_A_out_r.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_A_in "../tv/rtldatafile/rtl.top_kernel.autotvout_A_in.dat"
...
extern "C"
void apatb_top_kernel_hw(void* __xlx_apatb_param_A_in_r, void* __xlx_apatb_param_A_out_r)
{
  static hls::sim::Byte<4> __xlx_offset_byte_param_A_in_r;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_A_in_r),
#endif
  };
  port0.param = &__xlx_offset_byte_param_A_in_r;

  static hls::sim::Byte<4> __xlx_offset_byte_param_A_out_r;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_A_out_r),
#endif
  };
  port1.param = &__xlx_offset_byte_param_A_out_r;
  ...
  port2.param = { __xlx_apatb_param_A_in_r };
  port2.mname = { "A_in_r" };
  port2.nbytes = { 262144 };
  ...
  port3.param = { __xlx_apatb_param_A_out_r };
  port3.mname = { "A_out_r" };
  port3.nbytes = { 262144 };
  ...
  try {
    ...
    top_kernel_hw_stub_wrapper(__xlx_apatb_param_A_in_r, __xlx_apatb_param_A_out_r);
