...
output   A_out_r_c_write;
input  [2:0] A_out_r_c_num_data_valid;
input  [2:0] A_out_r_c_fifo_cap;
...
always @ (*) begin
    if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
        A_out_r_c_write = 1'b1;
    end else begin
        A_out_r_c_write = 1'b0;
    end
end
