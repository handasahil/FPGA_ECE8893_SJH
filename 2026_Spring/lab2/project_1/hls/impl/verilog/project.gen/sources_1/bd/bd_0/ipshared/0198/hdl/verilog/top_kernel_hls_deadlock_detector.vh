...
always @(negedge dl_reset or posedge dl_clock) begin
    ...
    top_kernel_hls_deadlock_detect_unit #(4, 0, 2, 2) top_kernel_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~entry_proc_U0.A_out_r_c_blk_n);
    ...
    top_kernel_hls_deadlock_detect_unit #(4, 1, 2, 2) top_kernel_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~read_input_U0.grid_initial_blk_n);
    assign proc_1_data_PIPO_blk[0] = 1'b0;
    assign proc_1_start_FIFO_blk[0] = 1'b0 | (~start_for_compute_U0_U.if_full_n & read_input_U0.ap_start & ~read_input_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~start_for_compute_U0_U.if_read);
    ...
    // Process: compute_U0
    top_kernel_hls_deadlock_detect_unit #(4, 2, 2, 2) top_kernel_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~compute_U0.grp_compute_Pipeline_VITIS_LOOP_34_1_VITIS_LOOP_35_2_fu_104.grid_initial_blk_n);
    ...
    assign proc_2_data_FIFO_blk[1] = 1'b0 | (~compute_U0.grp_compute_Pipeline_VITIS_LOOP_133_9_VITIS_LOOP_134_10_fu_131.grid_final_blk_n);
    ...
    top_kernel_hls_deadlock_detect_unit #(4, 3, 2, 2) top_kernel_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~write_output_U0.grid_final_blk_n);
    ...
    assign proc_3_data_FIFO_blk[1] = 1'b0 | (~write_output_U0.A_out1_blk_n);
    assign proc_3_data_PIPO_blk[1] = 1'b0;
    assign proc_3_start_FIFO_blk[1] = 1'b0 | (~start_for_write_output_U0_U.if_empty_n & write_output_U0.ap_idle & ~start_for_write_output_U0_U.if_write);
