...
set C_modelArgList {
	...
	{ in_r_r int 64 regular {axi_slave 0}  }
	{ out_r_r int 64 regular {axi_slave 0}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "in_r", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in_r_r","offset": { "type": "dynamic","port_name": "in_r_r","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "in_r_r", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":27}} , 
 	{ "Name" : "out_r_r", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":28}, "offset_end" : {"in":39}} ]}
...
set ArgLastReadFirstWriteLatency {
	top_kernel {
		...
		out_r_r {Type I LastRead 0 FirstWrite -1}}
	entry_proc {
		out_r_r {Type I LastRead 0 FirstWrite -1}
		out_r_r_c {Type O LastRead -1 FirstWrite 0}}
	K0 {
		in_r {Type I LastRead 9 FirstWrite -1}
		in_r_r {Type I LastRead 0 FirstWrite -1}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "65614", "Max" : "65614"}
...
dict set maxi_interface_dict in_r { CHANNEL_NUM 0 BUNDLE in_r NUM_READ_OUTSTANDING 16 NUM_WRITE_OUTSTANDING 16 MAX_READ_BURST_LENGTH 16 MAX_WRITE_BURST_LENGTH 16 READ_WRITE_MODE READ_ONLY}
dict set maxi_interface_dict out_r { CHANNEL_NUM 0 BUNDLE out_r NUM_READ_OUTSTANDING 16 NUM_WRITE_OUTSTANDING 16 MAX_READ_BURST_LENGTH 16 MAX_WRITE_BURST_LENGTH 16 READ_WRITE_MODE WRITE_ONLY}
