...
reg [15:0] trans_in_cnt_0;// for process K0_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_0 <= 16'h0;
    end
    else if (K0_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_0;// for process K0_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_0 <= 16'h0;
    end
    else if (K0_U0.ap_done == 1'b1 && K0_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_1;// for process K1_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_1 <= 16'h0;
    end
    else if (K1_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_1;// for process K1_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_1 <= 16'h0;
    end
    else if (K1_U0.ap_done == 1'b1 && K1_U0.ap_continue == 1'b1) begin
...
always @(negedge dl_reset or posedge dl_clock) begin
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~entry_proc_U0.out_r_r_c_blk_n);
    assign proc_0_data_PIPO_blk[0] = 1'b0;
    assign proc_0_start_FIFO_blk[0] = 1'b0 | (~start_for_K4_U0_U.if_full_n & entry_proc_U0.ap_start & ~entry_proc_U0.real_start & (trans_in_cnt_2 == trans_out_cnt_2) & ~start_for_K4_U0_U.if_read);
    ...
    assign proc_0_input_sync_blk[1] = 1'b0 | (ap_sync_entry_proc_U0_ap_ready & entry_proc_U0.ap_idle & ~ap_sync_K0_U0_ap_ready);
    ...
    // Process: K0_U0
    top_kernel_hls_deadlock_detect_unit #(6, 1, 3, 3) top_kernel_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~K0_U0.s0_to_k1_blk_n);
    assign proc_1_data_PIPO_blk[0] = 1'b0;
    assign proc_1_start_FIFO_blk[0] = 1'b0 | (~start_for_K1_U0_U.if_full_n & K0_U0.ap_start & ~K0_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~start_for_K1_U0_U.if_read);
    assign proc_1_TLF_FIFO_blk[0] = 1'b0;
    assign proc_1_input_sync_blk[0] = 1'b0;
    assign proc_1_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_1[0] = dl_detect_out ? proc_dep_vld_vec_1_reg[0] : (proc_1_data_FIFO_blk[0] | proc_1_data_PIPO_blk[0] | proc_1_start_FIFO_blk[0] | proc_1_TLF_FIFO_blk[0] | proc_1_input_sync_blk[0] | proc_1_output_sync_blk[0]);
    assign proc_1_data_FIFO_blk[1] = 1'b0 | (~K0_U0.s0_to_k2_blk_n);
    assign proc_1_data_PIPO_blk[1] = 1'b0;
    assign proc_1_start_FIFO_blk[1] = 1'b0 | (~start_for_K2_U0_U.if_full_n & K0_U0.ap_start & ~K0_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~start_for_K2_U0_U.if_read);
    ...
    assign proc_1_input_sync_blk[2] = 1'b0 | (ap_sync_K0_U0_ap_ready & K0_U0.ap_idle & ~ap_sync_entry_proc_U0_ap_ready);
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~K1_U0.s0_to_k1_blk_n);
    assign proc_2_data_PIPO_blk[0] = 1'b0;
    assign proc_2_start_FIFO_blk[0] = 1'b0 | (~start_for_K1_U0_U.if_empty_n & K1_U0.ap_idle & ~start_for_K1_U0_U.if_write);
    assign proc_2_TLF_FIFO_blk[0] = 1'b0;
    assign proc_2_input_sync_blk[0] = 1'b0;
    assign proc_2_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_2[0] = dl_detect_out ? proc_dep_vld_vec_2_reg[0] : (proc_2_data_FIFO_blk[0] | proc_2_data_PIPO_blk[0] | proc_2_start_FIFO_blk[0] | proc_2_TLF_FIFO_blk[0] | proc_2_input_sync_blk[0] | proc_2_output_sync_blk[0]);
    assign proc_2_data_FIFO_blk[1] = 1'b0 | (~K1_U0.s1_to_k3_blk_n);
    assign proc_2_data_PIPO_blk[1] = 1'b0;
    assign proc_2_start_FIFO_blk[1] = 1'b0 | (~start_for_K3_U0_U.if_full_n & K1_U0.ap_start & ~K1_U0.real_start & (trans_in_cnt_1 == trans_out_cnt_1) & ~start_for_K3_U0_U.if_read);
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~K2_U0.s0_to_k2_blk_n);
    assign proc_3_data_PIPO_blk[0] = 1'b0;
    assign proc_3_start_FIFO_blk[0] = 1'b0 | (~start_for_K2_U0_U.if_empty_n & K2_U0.ap_idle & ~start_for_K2_U0_U.if_write);
    assign proc_3_TLF_FIFO_blk[0] = 1'b0;
    assign proc_3_input_sync_blk[0] = 1'b0;
    assign proc_3_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_3[0] = dl_detect_out ? proc_dep_vld_vec_3_reg[0] : (proc_3_data_FIFO_blk[0] | proc_3_data_PIPO_blk[0] | proc_3_start_FIFO_blk[0] | proc_3_TLF_FIFO_blk[0] | proc_3_input_sync_blk[0] | proc_3_output_sync_blk[0]);
    assign proc_3_data_FIFO_blk[1] = 1'b0 | (~K2_U0.k2_to_k3_blk_n);
    ...
    // Process: K3_U0
    top_kernel_hls_deadlock_detect_unit #(6, 4, 3, 3) top_kernel_hls_deadlock_detect_unit_4 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~K3_U0.s1_to_k3_blk_n);
    assign proc_4_data_PIPO_blk[0] = 1'b0;
    assign proc_4_start_FIFO_blk[0] = 1'b0 | (~start_for_K3_U0_U.if_empty_n & K3_U0.ap_idle & ~start_for_K3_U0_U.if_write);
    assign proc_4_TLF_FIFO_blk[0] = 1'b0;
    assign proc_4_input_sync_blk[0] = 1'b0;
    assign proc_4_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_4[0] = dl_detect_out ? proc_dep_vld_vec_4_reg[0] : (proc_4_data_FIFO_blk[0] | proc_4_data_PIPO_blk[0] | proc_4_start_FIFO_blk[0] | proc_4_TLF_FIFO_blk[0] | proc_4_input_sync_blk[0] | proc_4_output_sync_blk[0]);
    assign proc_4_data_FIFO_blk[1] = 1'b0 | (~K3_U0.k2_to_k3_blk_n);
    ...
    assign proc_4_data_FIFO_blk[2] = 1'b0 | (~K3_U0.s3_to_k4_blk_n);
    ...
    assign proc_5_data_FIFO_blk[0] = 1'b0 | (~K4_U0.s3_to_k4_blk_n);
    ...
    assign proc_5_data_FIFO_blk[1] = 1'b0 | (~K4_U0.out_r_r_blk_n);
    assign proc_5_data_PIPO_blk[1] = 1'b0;
    assign proc_5_start_FIFO_blk[1] = 1'b0 | (~start_for_K4_U0_U.if_empty_n & K4_U0.ap_idle & ~start_for_K4_U0_U.if_write);
