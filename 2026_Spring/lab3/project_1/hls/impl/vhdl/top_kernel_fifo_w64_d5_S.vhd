...
entity top_kernel_fifo_w64_d5_S is 
    generic (
...
architecture rtl of top_kernel_fifo_w64_d5_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component top_kernel_fifo_w64_d5_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 5);
...
begin
----------------------- Instantiation -----------------------
    U_top_kernel_fifo_w64_d5_S_ShiftReg : top_kernel_fifo_w64_d5_S_ShiftReg
    generic map (
...
entity top_kernel_fifo_w64_d5_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 5);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end top_kernel_fifo_w64_d5_S_ShiftReg;

architecture rtl of top_kernel_fifo_w64_d5_S_ShiftReg is
