...
#define AUTOTB_TVOUT_in_r_r "../tv/cdatafile/c.top_kernel.autotvout_in_r_r.dat"
#define AUTOTB_TVIN_out_r_r "../tv/cdatafile/c.top_kernel.autotvin_out_r_r.dat"
#define AUTOTB_TVOUT_out_r_r "../tv/cdatafile/c.top_kernel.autotvout_out_r_r.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_in_r "../tv/rtldatafile/rtl.top_kernel.autotvout_in_r.dat"
...
extern "C"
void apatb_top_kernel_hw(void* __xlx_apatb_param_in_r_r, void* __xlx_apatb_param_out_r_r)
{
  static hls::sim::Byte<4> __xlx_offset_byte_param_in_r_r;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_in_r_r),
#endif
  };
  port0.param = &__xlx_offset_byte_param_in_r_r;

  static hls::sim::Byte<4> __xlx_offset_byte_param_out_r_r;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_out_r_r),
#endif
  };
  port1.param = &__xlx_offset_byte_param_out_r_r;
  ...
  port2.param = { __xlx_apatb_param_in_r_r };
  port2.mname = { "in_r_r" };
  port2.nbytes = { 262144 };
  ...
  port3.param = { __xlx_apatb_param_out_r_r };
  port3.mname = { "out_r_r" };
  port3.nbytes = { 262144 };
  ...
  try {
    ...
    top_kernel_hw_stub_wrapper(__xlx_apatb_param_in_r_r, __xlx_apatb_param_out_r_r);
