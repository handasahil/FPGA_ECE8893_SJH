...
`ifndef TOP_KERNEL_CONFIG__SV                        
    ...
    class top_kernel_config extends uvm_object;            
        ...
        int check_ena;                                      
        int cover_ena;                                      
        axi_pkg::axi_cfg in_r_cfg;
        axi_pkg::axi_cfg out_r_cfg;
        axi_pkg::axi_cfg control_cfg;

        `uvm_object_utils_begin(top_kernel_config)         
        `uvm_field_object(in_r_cfg, UVM_DEFAULT);
        `uvm_field_object(out_r_cfg, UVM_DEFAULT);
        ...
        function new (string name = "top_kernel_config");
            super.new(name);                                
        in_r_cfg = axi_pkg::axi_cfg::type_id::create("in_r_cfg");
        out_r_cfg = axi_pkg::axi_cfg::type_id::create("out_r_cfg");
